        ...
        **kwargs,
        ...
        if past_key_value.get_seq_length(self.layer_idx) == 0:
            ...
            for doc_id in range(num_docs):
                ...
                doc_position = all_position_ids[:, None, :].expand(bs, 1, all_input_len).clone() 
        ...
        dynamic_position = all_position_ids[:, None, None, :].expand(bs, 1, suffix_q_len, all_input_len).clone() # [bs, 1, 1, all input length]
        ### ROToR Change done ###
...
class Qwen2ForCausalLMWithPSRoToR(Qwen2PreTrainedModelWithPS):
