...
import sys
try:
    from PCW.modeling_gpt2_with_pcw import GPT2LMHeadPCW
    from PCW.pcw_wrapper import PCWModelWrapper
...
def load_pcw_wrapper(model_name: str, cache_dir: str = None,
    ...
    if 'gpt2' in model_name:
        ...
        if 'decapoda-research/llama-7b-hf' in model_name:
            ...
            # only for llama3
            model_args['_attn_implementation'] = 'eager' # sdpa or eager
        model_obj = LlamaForCausalLMPCW
        context_window_size = LLAMA_WINDOW_SIZE

    tokenizer = load_tokenizer(model_name)
    #m#odel_args['use_cache'] = False
